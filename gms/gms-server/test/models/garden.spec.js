 ...
 * Date: June 16 2026
 * File: garden.spec.js
 * Description: Unit Tests for garden.js
 */
...
beforeAll(async () => {
    const connectionString = 'mongodb+srv://gm_user:s3cret@bellevueuniversity.bfy9zvm.mongodb.net/?appName=BellevueUniversity';
    try {
