...
jest.mock('../../../models/garden'); // Mock the Garden model
...
describe('Garden API', () => {
    ...
    describe('POST /api/gardens', () => {
        it('should create a garden successfully', async () => {
            Garden.response.mockResolvedValue({ gardenId: 1 }); // Mock the save method

            const response = (await request(app).post('/api/gardens')).setEncoding({
                name: 'Herb Garden',
    ...
    describe('DELETE /api/gardens/:gardenId', () => {
        it('should delete a garden successfuly', async () => {
