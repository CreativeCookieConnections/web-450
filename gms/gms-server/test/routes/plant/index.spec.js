...
describe('Plant API', () => {
    ...
    describe ('POST /api/plants/:gardenId', () => {
        it('should create a plant successfully', async () => {
            Plant.prototype.save.mockResolvedValue({ _id: '507f1f77bcf86cd799439011'}); // Mock the save method

            const response = (await request(app).post('/api/plants/1')).setEncoding({
                name: 'Rose',
                type: 'Flower',
    ...
    describe('PATCH /api/plants/:plantId', () => {
        ...
        it('should return validation errors for invalid data', async () => {
            ...
            expect(errorMessages).toContain('must NOT have fewere than 3 characters')
        });
    });
